        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <div className="flex gap-4">
                    ...
                    <button type='button' disabled={uploading} onClick={handleImageSubmit} className='p-3 border border-green-700 rounded uppercase text-green-700 hover:shadow-lg disabled:opacity-80'>
